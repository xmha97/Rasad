...
func DefaultSites() []Site {
	return []Site{
		...
		{Name: "Zarebin (Site)", URL: "https://zarebin.ir/"},
		...
		{Name: "Reddit (Image)", URL: "https://preview.redd.it/"},
		{Name: "Reddit (Video)", URL: "https://packaged-media.redd.it/"},
		...
		{Name: "Telegram Profile (Shorten dog)", URL: "https://t.dog/"},
		{Name: "X (Site)", URL: "https://x.com/"},
		{Name: "X (Video Stream)", URL: "https://video.twimg.com/"},
		{Name: "X (Images)", URL: "https://pbs.twimg.com/"},
		...
		{Name: "DockerHub (Site)", URL: "https://www.hub.docker.com/"},
		{Name: "Microsoft Store (Site)", URL: "https://apps.microsoft.com/"},
		{Name: "Microsoft Store (Download)", URL: "https://tlu.dl.delivery.mp.microsoft.com/"},
		{Name: "GitHub (Site)", URL: "https://github.com/"},
		{Name: "GitHub Pages (Site)", URL: "https://pages.github.com/"},
		{Name: "GitHub (File Download)", URL: "https://raw.githubusercontent.com/"},
		{Name: "GitHub (Release Download)", URL: "https://objects.githubusercontent.com/"},
		...
		{Name: "YouTube (Profile Images)", URL: "https://yt3.ggpht.com/"},
		{Name: "YouTube (Thumbnails)", URL: "https://i.ytimg.com/"},
		{Name: "YouTube (Video Stream)", URL: "https://googlevideo.com/"},
	}
}
